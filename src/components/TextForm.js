...
const handleExtraSpaces = () => {
  ...
  const handleOnChange = (event)=>{   // how to handle events 
  ...
  return (
    ...
    <h1>{props.heading}</h1>
            <div className="mb-3" >   
    <textarea className="form-control" style={{backgroundColor : props.mode ==='dark'?'#1D2A35':'white',color: props.mode ==='dark'?'white':'black'}} value ={text} onChange={handleOnChange} id="myBox" rows="8"></textarea>
